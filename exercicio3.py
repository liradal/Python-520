...
#             #print('Lançando erro Cadastro de figuras') só tirar comentario e executar
#             raise ValueError('Voce tentou inserir uma figura publica')
